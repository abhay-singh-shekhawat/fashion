...
import { addClothingItem , getWardrobe , getWardrobeSuggestions , getOccasionSuggestion , removeClothingItem} from "../controllers/wardrobe.controller.js"
import {authMiddleware} from "../middlewares/auth.middleware.js"

const Router = express.Router()

Router.post("/add/item", authMiddleware , addClothingItem)
Router.delete("/remove/item/:id", authMiddleware , removeClothingItem)
